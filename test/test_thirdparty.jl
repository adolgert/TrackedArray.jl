...
@testset "ThirdParty:: Construction from minimal specification" begin
    ...
    physical_state = TrackedArray.ThirdParty.ConstructState(specification, Dict(:people => 3, :places => 2))
...
@testset "ThirdParty:: Consistency and correctness" begin
    using Distributions
    using Random
    using TrackedArray.ThirdParty
    ...
    physical_state = TrackedArray.ThirdParty.ConstructState(specification, counts)
