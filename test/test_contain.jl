...
@testset "Contain:: Construction from minimal specification" begin
    using TrackedArray.Contain
    ...
    physical_state = TrackedArray.Contain.ConstructState(specification, Dict(:people => 3, :places => 2))
...
@testset "Contain:: Consistency and correctness" begin
    using Distributions
    using Random
    using TrackedArray.Contain
    ...
    physical_state = TrackedArray.Contain.ConstructState(specification, counts)
