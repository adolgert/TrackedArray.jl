...
@testset "Doubles: Construction from minimal specification" begin
    using TrackedArray.Doubles
    ...
    physical_state = TrackedArray.Doubles.ConstructState(specification, Dict(:people => 3, :places => 2))
...
@testset "Doubles: Consistency and correctness" begin
    using Distributions
    using Random
    using TrackedArray.Doubles
    ...
    physical_state = TrackedArray.Doubles.ConstructState(specification, counts)
